...
(cl:defmethod cl:initialize-instance :after ((m <GetDepth-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetDepth-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kuka-srv:<GetDepth-request> is deprecated: use kuka-srv:GetDepth-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <GetDepth-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuka-srv:x-val is deprecated.  Use kuka-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <GetDepth-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuka-srv:y-val is deprecated.  Use kuka-srv:y instead.")
  (y m))
...
(cl:defmethod cl:initialize-instance :after ((m <GetDepth-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetDepth-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kuka-srv:<GetDepth-response> is deprecated: use kuka-srv:GetDepth-response instead.")))

(cl:ensure-generic-function 'depth-val :lambda-list '(m))
(cl:defmethod depth-val ((m <GetDepth-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuka-srv:depth-val is deprecated.  Use kuka-srv:depth instead.")
  (depth m))
